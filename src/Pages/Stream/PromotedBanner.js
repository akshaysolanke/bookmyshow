...
const PromotedBanner = ({ path, imgcardpath, isPremiere, title, movieName, slug, language, description }) => {
  return (
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-7 text-start d-flex align-items-center">
                    <div className="a_promoted_banner_main_forground_content text-white d-flex flex-column gap-4">
                        {isPremiere && <div style={{width:"fit-content"}} className='d-flex rounded-pill pe-2 gap-2 align-items-center a_bg_blackdark'>
                            <div className="a_play_icon">
                            <IoMdPlay />
                            </div>
                           <h6 className='a_h14 my-1 '>PREMIERE</h6>
                            </div>}
                            <h6>{title}</h6>
                            <h2>{movieName}</h2>
                            <h6>{slug}</h6>
